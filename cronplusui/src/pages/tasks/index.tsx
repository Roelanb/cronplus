  ...
  const renderTimingInfo = (task: TaskConfig) => {
    switch (task.triggerType) {
      case TriggerType.Time:
        return <p><span className="font-medium">Schedule:</span> {task.time || "Not specified"}</p>;
      case TriggerType.Interval:
        return <p><span className="font-medium">Interval:</span> {task.interval ? `${task.interval} seconds` : "Not specified"}</p>;
      default:
        return null;
    }
  };
